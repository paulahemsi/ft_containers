...
/*   Updated: 2022/02/16 18:29:12 by phemsi-a         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
template <typename T>
static void displayVector(const std::vector<T>& vector_)
{
...
static void test_constructors(void)
{
	...
	print_instructions("std::vector<int> emptyVector;");
	std::vector<int> emptyVector;
	displayVector(emptyVector);

	print_instructions("std::vector<int> fourElements(4);");
	std::vector<int> fourElements(4);
	displayVector(fourElements);

	print_instructions("std::vector<int> tenElements (10);");
	std::vector<int> tenElements(10);
	displayVector(tenElements);

	print_instructions("std::vector<int> tenElement90 (10, 90);");
	std::vector<int> tenElement90(10, 90);
	displayVector(tenElement90);

	print_instructions("std::vector<int> copyVector (tenElement90);");
	std::vector<int> copyVector(tenElement90);
	displayVector(copyVector);

	print_instructions("std::vector<int> partialCopy (tenElements.begin(), tenElements.begin() + 5);");
...
static void test_empty(void)
{
	...
	print_instructions("std::vector<int> my_vector;");
	...
	print_instructions("std::vector<int> four_elements(4);");
	std::vector<int> four_elements(4);
	displayVector(four_elements);
	print_instructions("four_elements.empty(): ");
	std::cout << four_elements.empty() << std::endl;
}

static std::vector<int> test_push_back(void)
{
...
static void test_out_of_bounds(void)
{
	...
	print_instructions("std::vector<int> integers(10);");
...
static void test_pop_back(std::vector<int> integers)
{
...
{
	print_title("  =  ");
	print_instructions("std::vector<std::string> string_vector2(2, nothing);");
	std::vector<std::string> string_vector2(2, "nothing");
