...
ft::btree<T>* btree_insert_data_recursive(ft::btree<T> **root, ft::btree<T> *parent, T *item, Compare compare)
{
	if (is_nil(*root))
	{
		delete *root;
...
template<class T, class Compare>
ft::btree<T>* btree_insert_data(ft::btree<T> **root, T *item, Compare compare)
{
