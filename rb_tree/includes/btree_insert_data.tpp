...
template<class T>
ft::btree<T>* btree_insert_data_recursive(ft::btree<T> **root, ft::btree<T> *parent, T *item, bool (*compare)(const T*, const T*))
{
	if (is_nil(*root))
	{
		delete *root;
...
template<class T>
ft::btree<T>* btree_insert_data(ft::btree<T> **root, T *item, bool (*compare)(const T*, const T*))
{
